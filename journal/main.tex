...
baselines isolate the contribution of the residual prior. For the expanded OSM
analyses, uncertainty uses an area-clustered hierarchical bootstrap with seed
nested within area, rather than treating seeds or scenarios as geographic
replicates. Across the expanded
...
expanded zero-shot OSM test, but inferential support is limited to three of nine
area-level intervals. The remaining signs are descriptive trends, not established
population effects. It combines the prior's ranking
...
cause. Because LOCO has only six country clusters, its targeted result is the
only cross-country contrast with inferential support; independent and spatial
signs remain descriptive. Consequently, the evidence establishes domain- and
...
training domain and failure regime. The method improves point estimates across GCN, GraphSAGE, and
...
Only three of nine expanded zero-shot contrasts and one of three matched LOCO
contrasts have clustered intervals excluding zero; all other signs remain
descriptive.
