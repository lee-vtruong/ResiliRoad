...
backbones and analytical baselines isolate the residual prior. For expanded OSM
analyses, uncertainty uses an area-clustered hierarchical bootstrap with seed
...
spectral setup from amortized cost. Within the limited geographic
...
graph-level anchor, separate that anchor experimentally from merely supplying
...
.256. Area-clustered intervals appear in Appendix Fig.~\ref{fig:revisioncontrols}.
...
Table~\ref{tab:modelbudget} summarizes parameter counts and common training
settings across backbones.
