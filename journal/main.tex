...
Two reviewer-motivated controls delimit competing explanations. First, we
...
\caption{Reviewer-motivated controls. (a) Topology-only transport-proxy error
...
\bibitem{resiliroad} V.-T. Le, ResiliRoad: residual spectral graph learning for
