...
nodes and about 2.1 edges per node. At 20,000 nodes, sparse exact recomputation
...
and GraphSAGE. Large-scale runtime graphs are generated deterministically;
sparse \texttt{eigsh} uses a fixed starting vector. The intact setup cost is
