...
(source lines 135--160), and the bounded formulation in Section 3.
...
Limitations, pp.~16--17 (source lines 622--681). The statistical unit and nested
bootstrap are defined in Section 4.3 (source lines 342--363).
...
transport-service metric. See Section 5.7, p.~13 (source lines 502--522), with
...
Section 5.7, p.~13 (source lines 502--522), and Limitations, pp.~16--17.
...
defined ``biased anchor'' at first use (Introduction, source lines 82--85), and
