# Journal of Complex Networks submission checklist

- [x] Standard `article.cls`; text block 126 mm by 195 mm; numbered pages.
- [x] Title, author, affiliation, correspondence and ORCID on the first page.
- [x] Abstract below 300 words and no more than six keywords.
- [x] Numbered sections and equations; appendices precede references.
